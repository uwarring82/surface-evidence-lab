...
| Location | Contents |
|---|---|
| `teaching/` | Review drafts, blank claim table, figure preparation brief, draft figure sheet with the attributed Croshaw figure, walkthrough protocol and AI desk check |
| `site/` | Lab webpage for GitHub Pages |
