...
5. **Only then scope the research pilot.** Establish a physical discrimination, lab benefit, acquisition/retention feasibility and standards fit before selecting an application stack. [Issue 05](planning/issues/05-research-feasibility.md)
6. **Settle repository stewardship and release terms.** Hosting and visibility are settled (public GitHub); renaming is optional. Choose maintainer and original-material licence; adopt issues and release conventions. [Issue 06](planning/issues/06-repository-stewardship.md)

Items 3, 4 and 6 can proceed independently when assigned. Completing the introductory packet neither requires a new infrastructure implementation nor closes the longitudinal, gap, revision or registration safeguards.
