...
Consolidated 17 September 2026. Scientific inspection and retrieval dates remain those recorded in the 10 September scout. This status describes completed work separately from proposed architecture.

## Completed

- A first-pass scout has selected two core cases and retained useful alternatives. This milestone is accepted at scout-level coverage; it is not a systematic or completed five-person-day survey.
...
| ID | Requirement | Current limit / closure evidence |
|---|---|---|
| U1 | Tracked longitudinal linkage | Reported sequences located, but the timed same-region exercise is unfinished. Complete a real longitudinal module and document which relationships remain unsupported; short intervention sequences alone do not close this. |
| U2 | History-gap characterisation | In-situ exchange has little missing-history complexity. Exercise a real interval with documented and unknown custody, storage or exposure, and show its effect on inference. |
| U3 | Real revision of an exact correspondence | Differently dated composition interpretations concern related phenomena. They do not revise the identity or location link between the exact same records. A hypothetical revision remains a teaching aid, not closure evidence. |
...
Finish and walk through the two-case teaching packet using [issue 01](planning/issues/01-teaching-prototype.md). Keep its readiness decision separate from closing the infrastructure safeguards. Supporting details remain in the [scout](literature/scout.md) and [task card](planning/task-card.md).
